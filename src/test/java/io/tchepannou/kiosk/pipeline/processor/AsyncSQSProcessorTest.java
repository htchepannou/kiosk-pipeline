...
public class AsyncSQSProcessorTest {
    @Mock
    AmazonSQS sqs;
    ...
    public void setUp (){
        ...
        processor.sqs = sqs;
        processor.executor = Executors.newFixedThreadPool(2);
    ...
    public void shouldProcessMessages() throws Exception {
        ...
        // Then
        assertThat(bodies).contains("m1", "m2", "m3");
    ...
    public void shouldIgnoreException() throws Exception {
        ...
        // Then
        assertThat(bodies).contains("m2", "m3");
        verify(sqs).deleteMessage("input-queue", "2");
        verify(sqs).deleteMessage("input-queue", "3");
    }
    ...
    public class Processor extends AsyncSQSProcessor  {
